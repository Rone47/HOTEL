      ...
      <div className='md:py-10 md:w-1/2 text-left'>
        ...
        <div className='flex flex-col md:flex-row md:items-end justify-between mt-5'>
          <div className='flex mb-3 md:mb-0'>
            <div className='flex gap-3 flex-col items-center justify-center mr-4 font-medium'>
          ...
          <Link
            ...
            className='border h-fit text-center border-sky-700 text-sky-700 px-3 py-2 lg:py-5 lg:px-7 rounded-2xl font-bold lg:text-xl'
          >
            More Details
          </Link>
        </div>
